...
INSERT INTO users VALUES("00000000","Ahmad", "Mahmoud", 'M', "12-12-2000", 230);
INSERT INTO users VALUES("00000001","Khaled", "Mahmoud", 'M', "13-1-1990", 200);
INSERT INTO users VALUES("01000000","Ali", "Omar", 'M', "11-2-1995", 300);
INSERT INTO users VALUES("02000000","Bahaa", "Mahmoud", 'M', "28-6-2001", 500);
INSERT INTO users VALUES("02000001","Omar", "Ahmad", 'M', "30-10-2000", 400);
INSERT INTO users VALUES("09000000","Bahaa", "Assad", 'M', "28-6-2001", 1000);
...
INSERT INTO rules VALUES ("members manager", "The manager for all information of members"); 
INSERT INTO rules VALUES ("financial", "the manager for the financial in the library");
INSERT INTO rules VALUES ("book", "arrangement of all new book inter the library");  
INSERT INTO rules VALUES ("book", "arrangement of the exist book in the library"); 
---------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------
-- member table
...
INSERT INTO deduction VALUES(0,4,IF(vaction_days > allowd_vaction_days, (vaction_days - allowd_vaction_days)/(30 - allowd_vaction_days)  ,  0));
...
CREATE TABLE employee_to_rules(
      ...
      FOREIGN KEY (rule_name, rule_description)
      REFERENCES rules(rule_name, rule_description)
      ON DELETE CASCADE
      ON UPDATE CASCADE
);

INSERT INTO employee_to_rules VALUES ("01000000", "members manager", "The manager for all information of members"); 
INSERT INTO employee_to_rules VALUES ("02000001", "financial", "the manager for the financial in the library");
INSERT INTO employee_to_rules VALUES ("02000000", "book", "arrangement of all new book inter the library");  
INSERT INTO employee_to_rules VALUES ("02000000", "book", "arrangement of the exist book in the library"); 
-----------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------
-- publisher table
...
INSERT INTO new_users(firstName, lastName, gender, birthDate, financialBalance, phone1, phone2,password, isEmployee) 
VALUES("ali", "ali", 'M', "12-12-2000", 120,"000000000", "000000001","123", true);

INSERT INTO new_users(firstName, lastName, gender, birthDate, financialBalance, phone1, phone2,password, isEmployee) 
VALUES("ali", "ali", 'M', "12-12-2000", 120,"1000000000", "1000000001","123", false);
